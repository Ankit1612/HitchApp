...
public class TabFragmentActivity extends Fragment {
    private RecyclerView mRootView;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mRootView = (RecyclerView) inflater.inflate(R.layout.activity_tab_fragment, container, false);
        return mRootView;
    }
    ...
    public static Fragment newInstance() {
        return new TabFragmentActivity();
    }
    ...
    private static class FakePageAdapter extends RecyclerView.Adapter<FakePageVH> {
        ...
        public FakePageVH onCreateViewHolder(ViewGroup viewGroup, int i) {
            View itemView = LayoutInflater.from(viewGroup.getContext())
                    .inflate(R.layout.list_tab_item, viewGroup, false);
